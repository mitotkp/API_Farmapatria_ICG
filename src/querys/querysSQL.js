export class cQuerysSQL {
  ...
  static getFacturaCompra = `
        ...
        FROM 
            ...
            INNER JOIN ALBCOMPRACAB ACC ON FC.NUMSERIE = ACC.NUMSERIEFAC AND FC.NUMFACTURA = ACC.NUMSERIEFAC AND FC.N = ACC.N
        WHERE 
  ...
  static getClientes = `SELECT * FROM CLIENTES`;

  static getCliente = `SELECT * FROM CLIENTES WHERE CODCLIENTE = @CODCLIENTE`;

  static getProveedores = `SELECT * FROM PROVEEDORES`;
