...
`;
  ...
  static insertarGuia = `
    INSERT INTO FARMAPATRIAGUIAS ( NUMGUIASICM, SERIEFAC, NUMFAC, CODCLIENTE, ESTATUS, RESPUESTASICM )
    VALUES (@GUIA, @SERIE, @NUMERO, @CLIENTE, @ESTATUS, @LINK)
  `;
